...
class TestAlertsArea:
    ...
    def test_confirm_button_accept(self, driver):
        ...
        aa.validate_confirm_button_text()
        aa.accept_alert()
        aa.validate_confirm_button_close_accept()
    ...
    def test_confirm_button_dismiss(self, driver):
        ...
        aa.validate_confirm_button_text()
        aa.dismiss_alert()
        aa.validate_confirm_button_close_dismiss()

    def test_prompt_button_accept(self, driver):
        aa = ElementsAlertsArea(driver)
        aa.open_alerts_page()
        aa.select_prompt_button()
        aa.validate_prompt_button_text()
        aa.alert_send_keys("Billy")
        aa.accept_alert()
        aa.validate_prompt_button_close_accept()
